...
searchBar.placeholder = "Search in current window..."

const leftTitleBarActions = document.createElement("div");
leftTitleBarActions.id = "title-bar-left-actions";

const rightTitleBarActions = document.createElement("div");
rightTitleBarActions.id = "title-bar-right-actions";

titleBar.appendChild(leftTitleBarActions);
titleBar.appendChild(sessionName);
titleBar.appendChild(searchBar);
titleBar.appendChild(rightTitleBarActions);
container.insertAdjacentElement("afterbegin", tabs);
container.insertAdjacentElement("afterbegin", titleBar);
